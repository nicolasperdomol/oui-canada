          ...
          <Card>
            <Card.Body className='p-5'>
              ...
              <form className='container-fluid' onSubmit={sendEmail}>
                <div className='row'>
                  <div className='p-1'>
                    <div className='form-floating' id='floatingFirstName'>
                  ...
                  <div className='p-1'>
                    <div className='form-floating' id='floatingLastName'>
                  ...
                  <div className='p-1'>
                    ...
                    <div className='form-outline form-floating' id='floatingMessage'>
                      <textarea className='form-control' name='message' id='textAreaExample' rows='4' placeholder='message' />
                  ...
                  <Button type='submit' id='contactUsFormBtn' className={`mt-4 ${mainTheme}_contactUsFormBtn`}>Send</Button>
                </div>
              </form>
            </Card.Body>
          </Card>
